    ...
    <section className="relative min-h-screen flex flex-col overflow-hidden">
      ...
      <div className="flex-1 flex flex-col justify-center pt-14 md:pt-0">
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/[0.04] text-white/60 text-[9px] sm:text-[10px] font-semibold tracking-[0.15em] uppercase mb-6 border border-white/10 shadow-[0_0_30px_rgba(255,255,255,0.03)] backdrop-blur-sm whitespace-nowrap">
          ...
          {/* Headline */}
          <h1
            className="animate-fade-up font-[family-name:var(--font-syne)] text-[28px] sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-[1.1] mb-6"
          ...
          >
            <Link
              href="/why-byd"
              className="inline-flex items-center gap-1.5 px-4 py-2 min-h-[36px] rounded-full border border-white/[0.08] text-white/50 text-xs font-medium hover:bg-white/[0.04] hover:border-emerald-500/30 hover:text-emerald-400 transition-all"
            >
          ...
          >
            ...
            <div className="text-center">
              ...
              <a
                ...
                className="inline-flex items-center gap-1.5 mt-1 py-1.5 -my-1.5 text-sm font-bold text-emerald-400 hover:text-emerald-300 transition-colors"
              >
              ...
              <div className="flex items-center justify-center gap-3 mt-1.5">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1 py-1.5 -my-1.5 text-xs text-pink-400/70 hover:text-pink-300 transition-colors"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1 py-1.5 -my-1.5 text-xs text-blue-400/70 hover:text-blue-300 transition-colors"
                >
                  <svg viewBox="0 0 24 24" fill="currentColor" width="11" height="11">
      ...
      {/* Scroll indicator */}
      <div className="hidden sm:flex absolute bottom-2 left-1/2 -translate-x-1/2 z-10">
